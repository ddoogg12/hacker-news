...
function applyApliMixins(targetClass, baseClasses) {
...
function (_super) {
  ...
  NewsFeedApi.prototype.getData = function () {
    return this.getRequest(); //응답값(JSON데이터)을 객체로 바꿔서 반환
  };
...
;
;
applyApliMixins(NewsFeedApi, [Api]);
applyApliMixins(NewsDetailApi, [Api]);

function getData(url) {
  ajax.open('GET', url, false); //async = false(동기처리)

  ajax.send();
  return JSON.parse(this.ajax.response); //응답값(JSON데이터)을 객체로 바꿔서 반환
}
...
function (_super) {
  ...
  function NewsFeedView(containerId) {
    ...
    var template = "\n      <div class=\"bg-gray-600 min-h-screen\">\n        <div class=\"bg-white text-xl\">\n          <div class=\"mx-auto px-4\">\n            <div class=\"flex justify-between items-center py-6\">\n              <div class=\"flex justify-start\">\n                <h1 class=\"font-extrabold\">Hacker News</h1>\n              </div>\n              <div class=\"items-center justify-end\">\n                <a href=\"#/page/{{__prev_feed__}}\" class=\"text-gray-500\">\n                  Previous\n                </a>\n                <a href=\"#/page/{{__next_feed__}}\" class=\"text-gray-500 ml-4\">\n                  Next\n                </a>\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"p-4 text-2xl text-gray-700\">\n          {{__news_feed__}}\n        </div>\n      </div>\n    ";
  ...
  NewsFeedView.prototype.render = function () {
    ...
    this.setTemplateData('prev_feed', String(store.currentPage > 1 ? store.currentPage - 1 : 1));
    this.setTemplateData('next_feed', String(store.currentPage + 1));
    this.updateView();
  };
...
function (_super) {
  ...
  NewsDetailView.prototype.render = function () {
    var id = location.hash.substr(7); //id의 #제거를 위해 substr
